 ...
 * description: Sent the file to the server
 * author: David Yao
 * mail: xiang.okay@gmail.com
 * mention: i use the UTF encode the file name
 */
package nochump.util.extend {
	...
	public class ZipOutput2Java {
		...
		public function ZipOutput2Java() {
		...
		private function writeLOC(e:ZipEntry):void {
			...
			if ((e.flag & 8) == 8 && e.flag != ZipConstants.DECRYPT) {
		...
		private function getLength(fileName:String):int{
			return fileName.replace(/[^\x00-\xff]/g,"xxx").length;			
		}
		/*
